export default {
  ...
  linksSection: {
    ...
    cards: [
      { title: "Мероприятия", image: { name: "events", ext: "png" } },
      { title: "Фирменные магазины", image: { name: "shops", ext: "png" } },
      { title: "Сервисная поддержка", image: { name: "support", ext: "png" } },
      { title: "Блог", image: { name: "blog", ext: "png" } },
    ],
  },
  footer: {
    accordion: [
