...
const CONFIG = {
  ...
  OUTPUT_FILE: path.resolve(__dirname, "../assets/figmaFrames.json"), // Сохранение в корень/assets
};
...
async function generateNodeLog() {
  try {
    ...
    try {
      ...
      fs.writeFileSync(CONFIG.OUTPUT_FILE, JSON.stringify(logData, null, 2), "utf8");
